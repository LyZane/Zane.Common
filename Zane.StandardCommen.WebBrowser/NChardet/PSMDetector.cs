...
namespace Zane.StandardCommen.WebBrowser
{
    ...
    internal class PSMDetector
    {
        ...
        internal PSMDetector(NChardetLanguage langFlag)
        {
            initVerifiers(langFlag);
            Reset();
        }

        internal PSMDetector(int aItems, Verifier[] aVerifierSet, EUCStatistics[] aStatisticsSet)
        {
        ...
        internal void initVerifiers(NChardetLanguage currVerSet)
        {
            //int idx = 0 ;
